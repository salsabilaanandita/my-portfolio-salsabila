...
export const skills = [
  ...
  },
  {
    ...
    items: ["Git", "Vercel", "Laragon", "VsCode"],
  },
];
...
export const projects = [
  ...
  },
  {
    ...
    stack: ["ReactJS", "JavaScript", "Express.Js", "Tailwind"],
    image: perpusImg,
    liveUrl: "#",
  ...
  },
  {
    ...
    year: "2025",
    tags: ["Weather", "API"],
    stack: ["ReactJS", "JavaScript", "Weather API", "Tailwind", "Axios"],
    image: weatherImg,
    liveUrl: "#",
    githubUrl: "https://github.com/salsabilaanandita/pendeteksi-cuaca.git",
    featured: false, // Tampil di Home
    highlights: [
  ...
  },
  {
    ...
    stack: ["HTML5", "CSS", "JavaScript", "LocalStorage", "FontAwesome"],
    image: webshopImg,
    liveUrl: "#",
